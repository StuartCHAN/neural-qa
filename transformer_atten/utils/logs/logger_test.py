...
from transformer_atten.utils.misc import keras_utils
...
class BenchmarkLoggerTest(tf.test.TestCase):
  ...
  @mock.patch("transformer_atten.utils.logs.logger.config_benchmark_logger")
...
class BenchmarkFileLoggerTest(tf.test.TestCase):
  ...
  @mock.patch("transformer_atten.utils.logs.logger._gather_run_info")
