...
from transformer_atten.utils.flags import core as flags_core
...
_TARGET_VOCAB_SIZE = 73051 # 73051 > 30927*2=61854 #32768  # Number of subtokens in the vocabulary list.
_TARGET_THRESHOLD = 1000 # 327  # Accept vocabulary if size is within this threshold
#VOCAB_FILE = "vocab.en_sparql.%d" % _TARGET_VOCAB_SIZE
VOCAB_FILE = "vocab.en_sparql"
...
def main(unused_argv):
  ...
  eval_files = {
      "inputs": ['./data/QALD7/dev.en'],
      "targets": ['./data/QALD7/dev.sparql'],
  }  # keys
  
  # to split the train and test set
  tf.logging.info("Step 2/5: Spliting datasets into random train and test subsets")

  data_en = open('./data/QALD7/data.en', 'r', encoding='UTF-8').readlines()
  sparql_en = open('./data/QALD7/data.sparql', 'r', encoding='UTF-8').readlines()

  en_train, en_test, sparql_train, sparql_test = train_test_split( data_en, sparql_en, test_size=0.33, random_state=42)
  
  with open(train_files["inputs"][0], 'w', encoding='UTF-8') as train_en, open(train_files["targets"][0], 'w', encoding='UTF-8') as train_sparql :
    for t_en , t_spl in zip(en_train, sparql_train):
      train_en.write(t_en)
      train_sparql.write(t_spl) ;
      
  with open(eval_files["inputs"][0], 'w', encoding='UTF-8') as eval_en, open(eval_files["targets"][0], 'w', encoding='UTF-8') as eval_sparql :
    for e_en , e_spl in zip(en_test, sparql_test):
      eval_en.write(e_en)
      eval_sparql.write(e_spl) ;
...
def define_data_download_flags():
  ...
  flags.DEFINE_string(
      name="data_dir", short_name="dd", default="./data/QALD7",
      help=flags_core.help_wrap(
          "Directory for where the translate_ende_wmt32k dataset is saved."))
  flags.DEFINE_string(
      name="raw_dir", short_name="rd", default="./data/QALD7",
      help=flags_core.help_wrap(
...
"""
export PYTHONPATH="$PYTHONPATH:/data/DBPEDIA"

python data_preprocess.py --data_dir=./data/QALD7

# Train the model for 10 epochs, and evaluate after every epoch.
python transformer_main.py --data_dir=./data/DBNQA --model_dir=./data/DBNQA/model_DBNQA   --vocab_file=./data/DBNQA/vocab.en_sparql.32768  --param_set=big   --bleu_source=./data/DBNQA/data.en --bleu_ref=./data/DBNQA/data.en   

python transformer_main.py --data_dir=./data/QALD7 --model_dir=./data/QALD7/model_QALD7   --vocab_file=./data/QALD7/vocab.en_sparql   --param_set=big   --bleu_source=./data/QALD7/data.en --bleu_ref=./data/QALD7/data.en  

python transformer_main.py --data_dir=./data/QALD7 --model_dir=./data/QALD7/model_QALD7   --vocab_file=./data/QALD7/vocab.en_sparql   --param_set=big   
...
python transformer_main.py --data_dir=./data/QALD7/DATA_DIR --model_dir=./data/QALD7/model_QALD7   --vocab_file=./data/QALD7/vocab.en_sparql   --param_set=big  --bleu_source=./data/QALD7/dev.en --bleu_ref=./data/QALD7/dev.en 

python translate.py  --model_dir=./data/QALD7/model_QALD7   --vocab_file=./data/QALD7/vocab.en_sparql   --param_set=big  --file=./data/QALD7/test/test.en --file_out=./data/QALD7/test/test.sparql 

python translate.py  --model_dir=./data/QALD7/model_QALD7   --vocab_file=./data/QALD7/vocab.en_sparql   --param_set=big  --file=./data/QALD7/gerbil_qald7/eva.en --file_out=./data/QALD7/test/test.eva.sparql 

tensorboard --logdir=./data/QALD7/model_QALD7
