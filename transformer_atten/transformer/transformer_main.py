...
from transformer_atten.transformer import compute_bleu
from transformer_atten.transformer import translate
from transformer_atten.transformer.model import model_params
from transformer_atten.transformer.model import transformer
from transformer_atten.transformer.utils import dataset
from transformer_atten.transformer.utils import metrics
from transformer_atten.transformer.utils import schedule
from transformer_atten.transformer.utils import tokenizer
from transformer_atten.utils.accelerator import tpu as tpu_util
from transformer_atten.utils.export import export
from transformer_atten.utils.flags import core as flags_core
from transformer_atten.utils.logs import hooks_helper
from transformer_atten.utils.logs import logger
from transformer_atten.utils.misc import distribution_utils
from transformer_atten.utils.misc import model_helpers
...
def define_transformer_flags():
  ...
  flags.DEFINE_string(
      ...
      help=flags_core.help_wrap(
          ...
          "transformer_atten BLEU score. Both --bleu_source and --bleu_ref must be set. "
